...
class Gui:
    ...
    def __init__(self):
        ...
        self.camera_1 = CameraElement(tk, self.frm_cameras, "CAM 1", self.cameras.create_camera(0), self.log)
        self.camera_2 = CameraElement(tk, self.frm_cameras, "CAM 2", self.cameras.create_camera(1), self.log)
